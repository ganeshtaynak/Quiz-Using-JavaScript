...
const questions = [
    {
        title : 'Who is the captain of mens indian cricket team in all format?',
        options : [
            'KL Rahul', 
            'Virat Kohli', 
            'Jasprit Gumrah', 
    ...
    {
        title : 'Who has most number followers of on Instagram ?',
        options : [
            'Virat Kohli',
            'Justin Beiber',
            'Cristiano Ronaldo',
    ...
    {
        title : 'Mern Stack full form ?',
        options : [
            'MongoDB, Express.js, React.js, Node.js',
            'MongoDB, Ethernet, React, Node',
            'Meavan, Express.js, React, Node',
            'All of above'
        ],
        answer : '0',
        score : 1
